					...
					<div className="calculations__main">
						<div className="calculations__main-title">
							...
							<div className="calculations__main-title_sub">
								...
								сооружений, таких как насыпи, откосы, грунтовые дамбы и др., методом конечных элементов
								с использованием нелинейных моделей грунтов, и аналитическими методами. Также в лаборатории проводится 
								проектирование средств инженерной защиты (грунтовые стенки, анкерные системы, 
								геосинтетические конструкции и др.).
							</div>
